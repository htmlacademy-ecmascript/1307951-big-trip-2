...
export const destinationPoints = [
  {
  ...
  },
  {
    ...
    description: 'Paris, the City of Light, charms with its romantic boulevards, iconic Eiffel Tower and world-class art museums.',
    name: 'Paris',
    pictures: [
      {
  ...
  },
  {
    ...
    description: 'Rome, the Eternal City, boasts ancient ruins, baroque fountains and the grandeur of the Vatican.',
    name: 'Rome',
    pictures: [
      {
  ...
  },
  {
    ...
    description: 'Barcelona blends Gaudí\'s modernist architecture with sunny Mediterranean beaches and vibrant nightlife.',
    name: 'Barcelona',
    pictures: [
      {
  ...
  },
  {
    ...
    description: 'Amsterdam enchants with its picturesque canals, cycling culture and world-famous museums.',
    name: 'Amsterdam',
    pictures: []
  },
  {
  ...
  {
    id: 'f6g7h8i9-j0k1-2345-fg12-678901234567',
    description: 'London offers royal palaces, historic pubs and the world\'s most famous clock tower.',
    name: 'London',
    pictures: [
      {
  ...
  {
    id: 'g7h8i9j0-k1l2-3456-gh23-789012345678',
    description: 'Vienna dazzles with imperial palaces, classical music heritage and coffeehouse culture.',
    name: 'Vienna',
    pictures: [
      {
  ...
  {
    id: 'h8i9j0k1-l2m3-4567-hi34-890123456789',
    description: 'Prague\'s fairy-tale architecture features gothic castles, baroque churches and the famous astronomical clock.',
    name: 'Prague',
    pictures: [
      {
  ...
  {
    id: 'i9j0k1l2-m3n4-5678-ij45-901234567890',
    description: 'Budapest captivates with its thermal baths, hilltop castle and stunning Danube views.',
    name: 'Budapest',
    pictures: [
      {
  ...
  {
    id: 'j0k1l2m3-n4o5-6789-jk56-012345678901',
    description: 'Lisbon charms with its seven hills, colorful azulejo tiles and nearby beach resorts.',
    name: 'Lisbon',
    pictures: [
      {
  ...
  {
    id: 'k1l2m3n4-o5p6-7890-kl67-123456789012',
    description: 'Madrid pulses with world-class art museums, lively tapas bars and royal palaces.',
    name: 'Madrid',
    pictures: [
      {
  ...
  {
    id: 'l2m3n4o5-p6q7-8901-lm78-234567890123',
    description: 'Athens blends ancient wonders with modern Mediterranean lifestyle and island hopping.',
    name: 'Athens',
    pictures: [
      {
  ...
  {
    id: 'm3n4o5p6-q7r8-9012-mn89-345678901234',
    description: 'Stockholm spreads across 14 islands with colorful wooden houses and Nordic design.',
    name: 'Stockholm',
    pictures: [
      {
  ...
  {
    id: 'n4o5p6q7-r8s9-0123-no90-456789012345',
    description: 'Copenhagen delights with hygge atmosphere, colorful Nyhavn harbor and bicycle culture.',
    name: 'Copenhagen',
    pictures: [
      {
  ...
  {
    id: 'o5p6q7r8-s9t0-1234-op01-567890123456',
    description: 'Dublin offers literary heritage, Guinness brewery tours and lively traditional music pubs.',
    name: 'Dublin',
    pictures: [
      {
  ...
  {
    id: 'p6q7r8s9-t0u1-2345-pq12-678901234567',
    description: 'Edinburgh enchants with its medieval Old Town, hilltop castle and famous festival season.',
    name: 'Edinburgh',
    pictures: [
      {
  ...
  {
    id: 'q7r8s9t0-u1v2-3456-qr23-789012345678',
    description: 'Warsaw blends resilient history with modern skyscrapers and vibrant cultural scene.',
    name: 'Warsaw',
    pictures: [
      {
  ...
  {
    id: 'r8s9t0u1-v2w3-4567-rs34-890123456789',
    description: 'Porto captivates with port wine cellars, riverside cafés and colorful ceramic tiles.',
    name: 'Porto',
    pictures: [
      {
  ...
  {
    id: 's9t0u1v2-w3x4-5678-st45-901234567890',
    description: 'Brussels delights with Art Nouveau architecture, chocolate shops and EU headquarters.',
    name: 'Brussels',
    pictures: [
      {
  ...
  {
    id: 't0u1v2w3-x4y5-6789-tu56-012345678901',
    description: 'Zurich offers pristine lake views, chocolate factories and gateway to the Alps.',
    name: 'Zurich',
    pictures: [
      {
